...
export const getPhaseLabel = (phase: ProjectPhase) => {
  switch (phase) {
    case 'P1': return 'P1 (ML0~2)';
    case 'P2': return 'P2 (ML3)';
    case 'P3': return 'P3 (ML4)';
    case 'P4': return 'P4 (ML5~6)';
    case 'P5': return 'P5 (ML7)';
...
// Helper to get Local Date String (YYYY-MM-DD) correctly regardless of time of day
